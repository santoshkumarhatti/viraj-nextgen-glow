...
const testimonials = [
  {
    ...
    content: "veroram transformed our entire infrastructure. Their cloud migration strategy was flawless, and the AI automation they implemented saved us countless hours. Truly exceptional service.",
    rating: 5,
    avatar: "SJ"
  },
  {
    ...
    content: "Working with veroram has been a game-changer. Their cybersecurity audit uncovered vulnerabilities we didn't know existed, and their solutions were both comprehensive and easy to implement.",
    rating: 5,
    avatar: "MC"
  },
  {
